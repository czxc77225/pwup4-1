...
def video_example():
  ...
  for lv1 in tqdm(lv1s, ncols=120):
    ...
    t2s = Tex2Shape('./tex2shape/results_black_suit/pkls/spotlight_002.pkl')
    #./tex2shape/results_beatles_3/pkls/test3.pkl
    #./tex2shape/results_black_suit/pkls/rp_lee_posed_004_30k.pkl
